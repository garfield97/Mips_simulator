...
file_names='j jal srav sra srlv srl sllv sll add addu and div nor divu mult multu or slt sltu addi addi_max addiu andi lw ori xori corner arithmetic_overflow division_error' #Names of all non arithmetic filenames
